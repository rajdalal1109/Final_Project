                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text("${stops.busname.toString()} Travels",
                                                style: const TextStyle(fontSize: 18,fontWeight: FontWeight.w400)),
                                            SizedBox(height: 2,),
                                            Text("Bus ID : ${stops.busid.toString()}"),
                                            Row(
                                              children: [
                                                Text(
                                            ...
                                            SizedBox(height: 2,),
                                            Text("${stops.avSeats.toString()} Seats left",
                                                style: const TextStyle(
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.w300,
                                                    color: Color.fromRGBO(
                                        ...
                                        Column(
                                          children: [
                                            Text("₹${stops.price.toString()}",style: TextStyle(color: AppColors.primary,fontWeight: FontWeight.w700,fontSize: 18),),
                                          ],
                                        ),
                                      ],
                                    ),
